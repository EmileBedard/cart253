 ...
 * Pippin Barr
 *
 * Painting on the canvas by not filling the background
 * Involved playing around with ways of setting strokes and other
 * drawing settings via mouse variables
 */
